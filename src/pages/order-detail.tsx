  ...
  return (
    <div className="min-h-screen bg-[#f7f9f4] font-sans flex flex-col">
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 py-8">
        ...
        <div className="flex gap-1 bg-white rounded-2xl p-1.5 shadow-sm mb-6 overflow-x-auto relative">
          {statusTabs.map((tab) => (
            <button
              key={tab.key}
              onClick={() => setActiveTab(tab.key)}
              className="flex-1 min-w-fit text-sm font-semibold px-4 py-2.5 rounded-xl relative whitespace-nowrap transition-colors duration-200"
              style={{
            ...
            >
              ...
              {activeTab === tab.key && (
                <motion.span
                  ...
                  className="absolute inset-0 bg-[#4d7c0f] rounded-xl"
                  style={{ zIndex: 0 }}
