      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-6 max-h-[92vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            <button type="button" onClick={onClose} className="flex-1 border border-gray-200 text-gray-600 text-sm font-semibold rounded-lg py-2.5 hover:bg-gray-50 transition">Batal</button>
            <button type="submit" className="flex-1 bg-[#4a7c59] hover:bg-[#2d5a38] text-white text-sm font-semibold rounded-lg py-2.5 transition">Simpan Perubahan</button>
          </div>
        </form>
      </div>
    </div>
    ...
    <div className="space-y-4 max-w-2xl">
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
        ...
        <div className="flex gap-3">
          <button onClick={onEdit} className="flex-1 bg-[#4a7c59] hover:bg-[#2d5a38] text-white font-semibold text-sm rounded-lg py-2.5 transition">✏️ Edit Sesi</button>
        </div>
      </div>
    </div>
  );
      ...
      <div className="space-y-5">
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">Pantau sesi konsultasi aktif, reschedule jadwal, update link, dan kelola resume medis</p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm flex flex-col justify-between">
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-xs text-gray-400 mt-1 font-medium">Recorded sessions</p>
              </div>
          ...
          <div className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm flex flex-col justify-between">
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-xs text-green-500 mt-1 font-semibold">Confirmed payments</p>
              </div>
          ...
          <div className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm flex flex-col justify-between">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-xs text-gray-500 font-medium">Sesi Terkonfirmasi</p>
                <p className="text-2xl font-bold text-gray-900 mt-1">{stats.confirmed}</p>
                <p className="text-xs text-gray-400 mt-1">{stats.total ? Math.round((stats.confirmed / stats.total) * 100) : 0}% paid sessions</p>
              </div>
          ...
          <div className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm flex flex-col justify-between">
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-xs text-yellow-500 mt-1 font-semibold">BOOKED state sessions</p>
              </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-100 bg-gray-50">
                    <th className="text-left px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">ID Sesi</th>
                    <th className="text-left px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Pasien</th>
                    <th className="text-left px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Spesialis</th>
                ...
                <tbody className="divide-y divide-gray-50">
                  {data.length === 0 ? (
                    ...
                    <tr key={t.id} className="hover:bg-gray-50 transition">
                      <td className="px-4 py-3 text-xs font-mono font-bold text-gray-500">{t.id}</td>
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2.5">
                          <div className={`w-7 h-7 rounded-full ${t.userColor} flex items-center justify-center text-white text-[10px] font-bold flex-shrink-0`}>{t.userInitials}</div>
                          <span className="font-semibold text-gray-800 whitespace-nowrap text-sm">{t.user}</span>
                        </div>
                      </td>
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          <div className={`w-6 h-6 rounded-full ${t.nutriColor} flex items-center justify-center text-white text-[9px] font-bold flex-shrink-0`}>{t.nutriInitials}</div>
                          <div>
                      ...
                      <td className="px-4 py-3 text-xs text-gray-700 whitespace-nowrap font-medium">{t.tanggal}, {t.waktu}</td>
                      <td className="px-4 py-3 text-xs text-gray-600 whitespace-nowrap font-semibold">{t.metode}</td>
                      <td className="px-4 py-3">
                      ...
                      <td className="px-6 py-3 text-right">
                        <div className="flex items-center justify-end gap-3">
                          <button onClick={() => setSelectedSesi(t)} className="text-xs text-[#4a7c59] hover:text-[#2d5a38] font-bold transition">Detail</button>
                          <button onClick={() => setEditTarget(t)} className="text-gray-400 hover:text-blue-500 transition text-xs font-semibold">Reschedule / Edit</button>
                        </div>
                      </td>
                    </tr>
                  ))}
