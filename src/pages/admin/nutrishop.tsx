...
import { 
  ...
  RefreshCw, X, Calendar, ShoppingCart,
    ...
    try {
      ...
      const mapBackendOrder = (o: ShopOrder): TransaksiShop => {
        ...
        return {
          ...
          alamat: o.alamat ? `${o.alamat.alamatLengkap}, Kel. ${o.alamat.kelurahan}, Kec. ${o.alamat.kecamatan}` : "-",
          kota: o.alamat ? `${o.alamat.kota}, ${o.alamat.kodePos}` : "-",
